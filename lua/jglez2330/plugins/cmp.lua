...
local cmp = {
  ...
  -- =============================================
  {
    ...
    dependencies = {
      ...
      -- -----------------------------------
      {
        ...
        config = function() require("jglez2330.core.autopairs") end,
      },
    ...
    config = function() require("jglez2330.core.cmp") end,
...

  {
    ...
    config = function() require("jglez2330.core.mini.completion") end,
    event = { "InsertEnter" },
  },
