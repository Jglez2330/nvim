  ...
  -- =============================================
   {
    ...
    config = function()
      ...
      require("jglez2330.core.lsp.lspconfig")
    end,
    ...
    dependencies = {
      {
        ...
        config = function() require("jglez2330.core.lsp.mason") end,
        cmd = "Mason",
      },
    },
    config = function() require("jglez2330.core.lsp.mason-lspconfig") end,
